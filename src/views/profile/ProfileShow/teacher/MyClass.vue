...
<script>
  ...
  export default {
    ...
    data(){
      ...
      return{
        list: [
          {worktitle:"二元一次方程",img:"https://edu-image.nosdn.127.net/F355766D26A19A259FD020126628FD36.png",
            src:"112",type:"video", publishtime:"2020.04.30 10:35",applaudnum:10,
            worksClickNum:10,commentnum:20,commentState:"已评分",checkstate:"未审核通过"},
          {worktitle:"二元一次方程",
            ...
            worksClickNum:150,
            commentnum:20,
            commentState:"已评分",checkstate:"未审核通过"},
          {worktitle:"二元一次方程",img:"https://edu-image.nosdn.127.net/F355766D26A19A259FD020126628FD36.png",
            src:"112",type:"video", publishtime:"2020.02.30 11:35",applaudnum:1200,
            worksClickNum:170,commentnum:20,commentState:"已评分",checkstate:"已审核通过"},
          {worktitle:"二元一次方程",img:"https://edu-image.nosdn.127.net/F355766D26A19A259FD020126628FD36.png",
            src:"112",type:"video", publishtime:"2020.4.30 11:35",applaudnum:1,
            worksClickNum:109,commentnum:20,commentState:"已评分",checkstate:"已审核通过"}
            ],
