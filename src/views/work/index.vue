...
<!--    视频-->
  ...
  <video-show 
    v-if="work && work.type!='PPT'"
    :worksLink="work.worksLink" 
    class="work-show">
  </video-show>
    <iframe
    v-if="work && work.type!='video'"
    src='https://view.officeapps.live.com/op/view.aspxsrc=http://127.0.0.1:8989/test.ppt'
...
export default {
  ...
  data(){
    return{
      ...
      worksCount:{},
      order:true,
      pptUrl:'http://127.0.0.1:8989/test.ppt'
    }
  },
  created() {   
   },
